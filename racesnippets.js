// Shuffle horses if you have lost 7 out of the last 10 bets

if ( history.slice( -10 ).filter( ( obj ) => { return obj.won } ).length <= 3 ) { shuffleHorses() }
// need a way to stop it reactivating for a while after it has just shuffled
...
if ( horses[0].odds > 3 ) betToPlace( horses[0], cash * 0.2 )
